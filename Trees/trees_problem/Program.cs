...
class Program
{
    static void Main()
    {
        ...
        // Create a binary tree and fill out the rest of the code once satisfied 
       ...
       int choice = -1; 
        ...
        while (choice != 0){
            Console.WriteLine();
            Console.WriteLine($"To add to inventory select 1");
            Console.WriteLine($"To remove a item select 2");
            Console.WriteLine($"To view all items select 3");
            Console.WriteLine($"To search an item select 4");
            ...
            switch (choice){
                ...
                case 3:
                    Console.WriteLine("All items in order");
                    // Enter Code here
                    break;

                case 4:
                    Console.WriteLine($"Enter the item ID to search for: ");
                    // Enter Code here
                    break;
